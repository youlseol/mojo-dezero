...
class Variable:
    ...
    def backward(self, retain_grad=False, create_graph=False):
        ...
        Args:
            retain_grad (bool, optional): If True, retains the gradients of intermediate variables. Defaults to False.
            create_graph (bool, optional): If True, creates a new computational graph for the backward pass. Defaults to False.
        """
...
def setup_variable():
    ...
    Variable.matmaul = dezero.functions.matmul # type: ignore
    Variable.dot = dezero.functions.matmul # type: ignore
    Variable.max = dezero.functions.max # type: ignore
    Variable.min = dezero.functions.min # type: ignore
